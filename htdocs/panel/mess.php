                                ...
                                <div id="chat-list" class="chat-list">
                                    ...
                                    if($row != null){
                                        for($i=0;count($row)>$i;$i++){
                                           // $obj = json_decode(getnamebyid($row[$i]["sender"]),true);
                                            if(!isset($arr[$row[$i]["sender"]])){
                                                array_push($arr,$row[$i]["sender"]);}
                                    ...
                                    if($arr != null){
                                        ...
                                        for($i=0;count($arr)>$i;$i++){
                                            $obj = json_decode(getnamebyid($arr[$i]),true);
                                            echo '<a href="/mes?id='.$arr[$i].'"> <div id="friends" class="friends">
                    <!-- photo -->
                    <div class="profile friends-photo">
                        <img src="/images/profile/'.$arr[$i].'.png" alt="">
                    </div>
