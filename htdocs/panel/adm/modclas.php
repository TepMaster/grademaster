                    ...
                    <div class="rep-cards" style="">
                        <center>
                            <table style="width: 80%;">
                                ...
                                $results = DB::query("SELECT * FROM clase");
                                foreach ($results as $row) {
                                    $data="";
                                    $ser = unserialize($row["materi"]);
                                    foreach ($ser as $s){
                                        $data .= getmateriename($s)[0]["nume"]."(".$s.") ";
                                    }
                                    echo ' <tr>
                                <th>'.$row['id'].'</th>
                                <th>'.$data.'</th>
                                <th>'.$row['dirig'].'</th>
                                <th>'.$row['nume'].'</th>
                                <th><a href="/adm/modclase?id='.$row['id'].'" >Edit</a></th>
                            </tr>';}
...
if(isset($_POST["num"])){
    ...
    $arr = array("n"=>$_POST["num"],"r"=>"Elev","c"=>$_POST["cl"]);
