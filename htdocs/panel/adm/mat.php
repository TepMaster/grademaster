                    ...
                    <div class="rep-cards" style="">
                        ...
                        <div class="form">
                            ...
                            <form method="post" enctype="multipart/form-data" action="#">
                                <label for="grade">Nume materie:</label>
                                <input type="text" id="num" name="num" min="0" max="100" required>
                                <br><br>
                                <label for="grade">Nume Profesor:</label>
                                <input type="text" id="prof" name="prof" min="0" max="60" required>
                                <br><br>
                                <label for="grade">Email profesor:</label>
...
if(isset($_POST["num"])){
    ...
    'swal("Materie Adaugat!", "Ati adaugat materia cu succes!", "success").then(function() {
