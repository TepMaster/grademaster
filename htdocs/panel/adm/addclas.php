                    ...
                    <div class="rep-cards" style="">
                        ...
                        <div class="form">
                            ...
                            <form method="post" enctype="multipart/form-data" action="#">
                                ...
                                <input type="text" id="pass" name="pass" min="0" max="60" required>
                                <br><br>
                                <label for="grade">Materi:</label>
                                <input type="text" id="em" name="em" min="0" max="60" required placeholder="1,5,6">
                                <br><br>&nbsp;
...
if(isset($_POST["num"])){
    ...
    'swal("Clasa Adaugat!", "Ati adaugat clasa cu succes!", "success").then(function() {
