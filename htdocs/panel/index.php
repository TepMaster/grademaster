<?php
require $_SERVER['DOCUMENT_ROOT']."/panel/heder.php";
require  "helper.php";
                                ...
                                <?php
                                    ...
                                    if($row != null){
                                        for($i=0;(count($row))>$i;$i++){
                                            echo ' <div style="box-sizing: border-box; min-height: 1px; position: relative; padding-left: 7.5px; padding-right: 7.5px; width: 50%; flex: 0 0 50%; max-width: 50%; margin-left: 0%; right: auto; left: auto;">';

                                            echo '<a href="/blog?post='.$row[$i]["id"].'">
                                        <div class="news-preview-component">
                                            <div class="imgZone">
                                            ';
                                            if($row[$i]["image"]!=""){echo '<img src="'.$row[$i]["image"].'" alt="Invalid" style="min-width: 1000px;">';}
                                            echo'
                                      ...
                                      <span class="less-text linesNumber-2">
                                        <span>'.$row[$i]["titlu"].'</span>
                                      </span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="publicat">Publicat de '.json_decode(getnamebyid($row[$i]["userid"]),true)["n"].' | <span>'.$row[$i]["data"].'  <svg
  width="16"
  height="16"
  viewBox="0 0 24 24"
  fill="none"
...
>
  ...
  />
                                                                ...
                                                                <span class="number"> &nbsp;'.$row[$i]["viz"].'</span></span>
                                                        </div>
                                                    </div>
