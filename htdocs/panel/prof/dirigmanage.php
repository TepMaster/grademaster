                    ...
                    <div class="report-card-grades-container false">
                        <div class="report-card-grades">
                            <table class="comp-table">
                                ...
                                $mot = DB::query("SELECT * FROM logins WHERE id =%s",$_GET["student"]);
