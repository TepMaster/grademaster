            ...
            <div style="box-sizing: border-box; min-height: 1px; position: relative; padding-left: 0px; padding-right: 0px; width: 83.3333%; flex: 0 0 83.3333%; max-width: 83.3333%; margin-left: 0%; right: auto; left: auto;">
                <div class="rep-cards" style="">
                    <div class="report-cards-tabs">
                        <div class="comp-tabs">
                            <center><h2 style="font-family: Garamond, 'Times New Roman', serif;font-size: 32px;font-weight: bolder;color: rgb(145, 222, 148);"> <?php echo  getclase( $_SESSION["dirig"])[0]["nume"];?></h2></center><br>

                            <?php
                            $student = DB::query("SELECT * FROM logins WHERE clasa =%s", $_SESSION["dirig"]);
                            //var_dump($student);
                            ...
                            if($student!=null){
                                for($i=0;count($student)>$i;$i++){
                                    ...
                                    echo '<a style="float: left;margin: 10px;" href="/dirigmanage?student='.$student[$i]["id"].'&materie='. $_SESSION["dirig"].'" ><img src="'.$poza.'" alt="Button Image"><br><spam>'.$obj["n"] .'</spam></a>';
