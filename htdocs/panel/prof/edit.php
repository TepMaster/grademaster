...
require 'heder.php';
require "helper.php";
$note = DB::query("SELECT * FROM note WHERE id =%s",$_GET["gradeid"]);
$not=0;$cio="";
if($note!=null){
   $not=$note[0]["nota"];
   $dat = $note[0]["data"]; $cio = $note[0]["coment"];
}
?>
                    ...
                    <div class="rep-cards" style="">
                        ...
                        <div class="form">
                            ...
                            <form method="post">
                                ...
                                <input type="number" id="grade" name="grade" min="0" max="100" value="<?php echo $not; ?>">
                                <br><br>
                                <label for="grade">Comentariu:</label>
                                <input type="text" id="com" name="com" min="0" max="60" placeholder="optional" value="<?php echo $cio; ?>">
                                <br><br>
...
if(isset($_POST["grade"])){
    DB::update('note', ['nota' => $_POST["grade"], 'coment' => $_POST["com"]], "id=%s", $_GET["gradeid"]);
    echo '<script type="text/javascript">',
    'swal("Nota Modificata!", "Ati modificat nota cu succes!", "success").then(function() {
