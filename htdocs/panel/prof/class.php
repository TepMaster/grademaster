                    ...
                    <div class="news-list-component">
                        <div style="box-sizing: border-box; position: relative; margin-left: auto; margin-right: auto; padding-left: 15px; padding-right: 15px;">
                            ...
                            <div style="margin-left: -7.5px; margin-right: -7.5px; display: flex; flex-flow: row wrap; flex-grow: 0; flex-shrink: 0; align-items: normal; justify-content: flex-start;">
                                ...
                                if($_SESSION["rank"]==10){
                                    $nr =0;
                                    $stat = DB::query("SELECT * FROM profcls");

                                    if($stat!=null) {
                                        $clase = unserialize($stat[0]["classarray"]);
                                    ...
                                    <a href="/addnote?materieid='.$clase[$i][0].'&classid='.$clase[$i][1].'">
                                        ...
                                        <div class="contentZone">
                                            <div class="up-wrapper">
                                                <div class="content-wrapper">
                                                    <div class="tagZone">
                                                        ...
                                                        <div class="news-heart-coponent">
                                                            <button type="button" class="icon-props__wrapper">
                                                                <span class="number">Clasa:  ' . getclase($clase[$i][1])[0]["nume"] . '</span>
                                                            </button>
                                                    ...
                                                    <div class="publicat">Diriginte ' . getclase($clase[$i][1])[0]["dirig"] . ' <span></span>
                                                    </div>
                                                </div>
...
';
                                ...
                                $nr =0;
                                $stat = DB::query("SELECT * FROM profcls WHERE userid =%s",$_SESSION["usr_id"]);
