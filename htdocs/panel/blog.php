...
<div id="react-app">
  ...
  <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466 4.176 9.032Zm-.068 1.873.22-.748 3.496 1.311a.5.5 0 0 0 .352 0l3.496-1.311.22.748L8 12.46l-3.892-1.556Z"/>
           ...
           if(isset($_GET["post"])){
            ...
            ?>
            <div style="box-sizing: border-box; min-height: 1px; position: relative; padding-left: 0px; padding-right: 0px; width: 83.3333%; flex: 0 0 83.3333%; max-width: 83.3333%; margin-left: 0%; right: auto; left: auto;"><div class="comp-news" style=""><div class="news-item-coponent false"><div class="title-zone"><div class="comp-header-title header-title-top  ">


                                    </span><div class="ladda-progress" style="width: 0px;"></div>
                                </button>
                                <div class="content-text"><div class="title"><?php echo getnewsby($post)["titlu"];?></div><div class=""><div class="secondRow"><div class="news-tag-coponent"><div class="grademaster shape">GradeMaster</div></div><div class="publicat">Publicat de <?php echo json_decode(getnamebyid(getnewsby($post)["userid"]),true)["n"];?> | <span><?php echo getnewsby($post)["data"];?></span>
                                            </div></div></div></div></div></div><div class="content"><div class="pictureArea">
                                <img src="<?php echo getnewsby($post)["image"];?>" alt="Invalid"></div><div class="contentArea"><?php echo getnewsby($post)["text"];?>
                                </div></div></div></div></div>
        </div>
    </div>
</div>
